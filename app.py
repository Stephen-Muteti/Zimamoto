...
def create_connection():
    DATABASE_URL = 'postgres://voqarviqppiaxy:8894b0fc40c8cec4851d5c0b1f2db09cdac15601b53aeeb13370f71ff6633de9@ec2-54-234-13-16.compute-1.amazonaws.com:5432/dccq9nlonogo7t'
...
def add_user():
    try:
        ...
        name = data['name']
        email = data['email']
        phone = data['phone']  # New field: phone number
        role = data['role']
        ...
        if connection:
            ...
            cursor = connection.cursor()
            insert_query = '''
                INSERT INTO users (name, email, phone, role, password)  # Include 'phone' in the query
                VALUES (%s, %s, %s, %s, %s)
            '''
